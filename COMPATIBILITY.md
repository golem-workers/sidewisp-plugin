...
1. Stop or restart the runtime normally so any active collector writer closes
   its SQLite lock. Codex and Claude Code hooks are short-lived and retry a
   concurrent writer on the next event.
